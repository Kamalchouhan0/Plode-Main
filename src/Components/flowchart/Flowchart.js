...
function Flowchart() {
  const [img, setImg] = useLocalStorage("img1", [
  ...
  const onImage2Concat = () => {
    setImg2((img2) =>
      img2.concat({ id: Date.now(), defaultPosition: { x: 0, y: 0 } })
    );
  };
  const onImage3Concat = () => {
    setImg3((img3) =>
      img3.concat({ id: Date.now(), defaultPosition: { x: 0, y: 0 } })
    );
  };
  const onImage4Concat = () => {
    setImg4((img4) =>
      img4.concat({ id: Date.now(), defaultPosition: { x: 0, y: 0 } })
    );
  };
  const onImage5Concat = () => {
    setImg5((img5) =>
      img5.concat({ id: Date.now(), defaultPosition: { x: 0, y: 0 } })
    );
  };
  const onImage6Concat = () => {
    setImg6((img6) =>
      img6.concat({ id: Date.now(), defaultPosition: { x: 0, y: 0 } })
    );
  };
