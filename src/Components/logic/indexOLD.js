...
var Logic = React.createClass({
  ...
  showHints: function () {
    const node = document.querySelector(".hints");
    node.classList.add("animated", "zoomInRight");
    document.getElementsByClassName("hide_show_btn")[0].style.display = "none";
  ...
  closeHints: function () {
    document.getElementsByClassName("hints")[0].style.display = "none";
    document.getElementsByClassName("hide_show_btn")[0].style.display = "block";
  },
  /**
  ...
  initEditor: function () {
    ...
    if (!appStateCode) {
      ...
      editor.setValue(
        [
          ,
          "// C programming for BIBOX",
          "",
          '#include "bibox.h"    //DO NOT DELETE this COMMAND/HEADER',
          "#include <stdint.h>   //DO NOT DELETE this COMMAND/HEADER",
          "#include <string.h>   //DO NOT DELETE this COMMAND/HEADER",
          "#include <stdbool.h>  //DO NOT DELETE this COMMAND/HEADER",
          "#include <math.h>     //DO NOT DELETE this COMMAND/HEADER",
          "",
          " void setup(void)",
          "{",
          "SET_AS_OUTPUT(A1);",
        ...
        <div>
          ...
          >
            <div>
              ...
              {/* {(localStorage.getItem("connectivity-type")=="USB")?(<button style={{ float: 'left', marginRight: '1%', padding: 0, border: '3px solid transparent' }} type="button" onClick={this.editorButtonClicked} ><img title="Coding Screen coming soon" style={{ height: '40px', width: '40px' }} src="./images/cright.png" /></button>):""} */}
              <button
                style={{
                  float: "left",
                  marginRight: "1%",
              ...
              >
                <img
                  title="Coding Screen"
                  style={{ height: "40px", width: "40px" }}
                  src="./images/icon_image_blocky.png"
                />
              </button>
            </div>
          </div>
          ...
          <div id="mainMenu" style={{ height: "100%" }}>
            ...
            >
              <div>
                ...
                {/* {(localStorage.getItem("connectivity-type")=="USB")?(<button style={{ float: 'left', marginRight: '1%', padding: 0, border: '3px solid #F9CB2F' }} type="button" onClick={this.editorButtonClicked} ><img title="Coding Screen coming soon" style={{ height: '40px', width: '40px' }} src="./images/cright.png" /></button>):""} */}
                <button
                  style={{
                    float: "left",
                    marginRight: "1%",
              ...
              >
                ...
                >
                  ...
                  >
                    <div>
                      <p>
                        SET_AS_INPUT(PORT NAME);; Setting a particular PORT as
                        INPUT digital. EX:- SET_AS_INPUT(A1);
                        <br />
                        SET_AS_OUTPUT(PORT NAME); setting a particular PORT as
                        OUTPUT digital, EX:- SET_AS_OUTPUT(B2);
                        <br />
                        WRITE_LOGIC(PORT NAME, LOGIC); writing a logic value to
                        a particular PORT, EX:- WRITE_LOGIC(A2, HIGH); OR
                        WRITE_LOGIC(A2, LOW);
                        <br />
                        READ_PIN(PORT NAME);Reading a LOGIC Value of the
                        particular PORT, EX:- READ_PIN(A1);
                        <br />
                        ENABLE_PWM(PORT NAME);Enabling a PWM value of the
                        particular PORT,EX:- ENABLE_PWM(A2);
                        <br />
                        WRITE_PWM(PORT NAME, VALUE); writing a PWM value of the
                        particular PORT, EX:- WRITE_PWM(A2, 255);
                        <br />
                        PULSE(PORT NAME, TIME delay in milliseconds, LOGIC);
                        Writing a PULSE signal to a particular PORT., EX:-
                        PULSE(A1, 3, HIGH);
                        <br />
                      </p>
                      <br />
                      <p>
                        <h3> MOTORS</h3>
                        ENABLE_SERVO(PORT NAME);Enable servo motor. Only PORT A2
                        and A3 possible,EX:- ENABLE_SERVO(A2);
                        <br />
                        WRITE_SERVO(PORT NAME, DEGREE); Writing a Degree value
                        to the PORT,EX:- WRITE_SERVO(A2, 120);
                        <br />
                        ENABLE_MOTOR1();To enable M1 Motor;port,EX:-
                        ENABLE_MOTOR1();
                        <br />
                        ENABLE_MOTOR2();To enable M2 Motor,EX:- ENABLE_MOTOR2();
                        <br />
                        MOTOR_1(VALUE); Write a Value to M1 Motor Port.VALUE
                        will vary from -20 to +20,EX:- MOTOR_1(-15);
                        <br />
                        MOTOR_2(VALUE);Write a Value to M2 Motor Port.VALUE will
                        vary from -20 to +20,EX:- MOTOR_2(20);
                        <br />
                      </p>
                      <br />
                      <p>
                        <h3> ADC </h3>
                        ADC_DISABLE();Disabling ADC on the PORTS,EX:-
                        ADC_DISABLE();
                        <br />
                        ADC_READ(PORT NAME);Reading a ADC value of the
                        particular PORT,EX:- int value= ADC_READ(A2);
                        <br />
                        ADC_RESOLUTION(BIT SIZE);Setting the bit size of the ADC
                        resultant,EX:- ADC_RESOLUTION(10);
                        <br />
                      </p>
                      <br />
                    </div>
